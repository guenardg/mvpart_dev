...
void pred_rpart(Sint *dimx, Sint *nnode, Sint *nsplit, Sint *dimc, Sint *nnum,
                Sint *nodes2, Sint *vnum, double *split2, Sint *csplit2,
                Sint *usesur, double *xdata2, Sint *xmiss2, Sint *where) {
  int i,j;
  int n;
  int ncat;
